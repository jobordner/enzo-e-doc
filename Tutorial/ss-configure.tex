...
\begin{semiverbatim}
 ...
 \uncover<4->{\prompt \redcode{CELLO_ARCH=linux_gnu; export CELLO_ARCH}}\cursor{4}  
 \uncover<5->{\prompt \redcode{CELLO_PREC=double; export CELLO_PREC}}\cursor{5}  
