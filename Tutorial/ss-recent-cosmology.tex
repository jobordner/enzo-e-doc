...
\only<1->{\includegraphics[width=4.0in]{Images/b345-redshift.png}}
\end{minipage} \ 
\end{center}
\end{frame}
...
\begin{center}
\begin{minipage}{4.0in}
\only<1->{\includegraphics[width=4.0in]{Images/b345-bytes.png}}
\end{minipage} \ 
\end{center}
\end{frame}
...
\begin{center}
\begin{minipage}{4.0in}
\only<1->{\includegraphics[width=4.0in]{Images/b345-time-per-cycle-log.png}}
\end{minipage}
\end{center}
\end{frame}
...
\begin{center}
\begin{minipage}{4.0in}
\only<1->{\includegraphics[width=4.0in]{Images/b345-bcg-iters.png}}
\end{minipage}
\end{center}
\end{frame}
