...
%\newcommand{\cursor}[1]{\uncover<#1>{\begin{animateinline}[autoplay,loop]{2.0}\strut\textbf{\_}\newframe\newframe[5]\end{animateinline}}}
...
\newcommand{\ssClasses}{How are C++ classes in Enzo-P/Cello organized?}
...
\newcommand{\ssCharmSummary}{Charm++ Summary}
\newcommand{\ssControlSummary}{Control Summary}
\newcommand{\ssDesignSummary}{Design Summary}
\newcommand{\ssDevelSummary}{Development Summary}
\newcommand{\ssFutureSummary}{Unfinished Business Summary}
\newcommand{\ssIntroSummary}{Enzo-P/Cello Summary}
\newcommand{\ssParametersSummary}{Parameters Summary}
\newcommand{\ssPresentSummary}{Current Status Summary}
\newcommand{\ssRecentSummary}{New Features Summary}
\newcommand{\ssProjectSummary}{Project Organization Summary}
\newcommand{\ssStartingSummary}{Getting Started Summary}
