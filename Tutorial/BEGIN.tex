...
\newcommand{\sRecent}{Recent functionality}
\newcommand{\ssRecentParticles}{Particle support in Cello}
\newcommand{\ssRecentGravity}{Scalable gravity in Enzo-P}
\newcommand{\ssRecentIo}{Support MUSIC initial conditions}
\newcommand{\ssRecentHistory}{History of Field data in Enzo-P}
\newcommand{\ssRecentUnits}{Units in Enzo-P}
\newcommand{\ssRecentCosmology}{Cosmology in Enzo-P}
...
\date[2017-06-5/8]{Enzo Workshop\\
            5-8 June 2017}}
